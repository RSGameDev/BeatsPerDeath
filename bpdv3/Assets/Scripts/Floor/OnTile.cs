...
//
        ...
        /*public void PermissionToMove()
        {
            ...
            if (NextMoveGameObjects.Count == 1)
            {
                ...
                _nextMoveAllowedGO = NextMoveGameObjects[0];
            ...
            if (NextMoveGameObjects.Count == 2)
            {
                ...
                _nextMoveAllowedGO = NextMoveGameObjects[allowed];
        ...
        public void ContinueOrHold() // *********NEED TO ASSESS***********
        {
            //if (GOonTile.Count == 0)
            //{
            //    return;
            ...
            if (GOonTile.Count == 1)
            {
                if (!GOonTile[0].GetComponentInChildren<EnemyNextMove>().hasPermission)
                {
                    ...
                    //    return;
                    //}
                    if (_nextMoveAllowedGO == null)
                    {
                        return;
                    }
                    _nextMoveAllowedGO.GetComponent<EnemyNextMove>().hasPermission = false;
                }
            }
        }
